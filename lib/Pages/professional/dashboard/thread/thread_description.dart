...
class Threaddespro extends StatefulWidget {
  String query = "";
  Threaddespro(this.query, {Key? key}) : super(key: key);
  @override
  State<Threaddespro> createState() => _ThreaddesproState();
}

class _ThreaddesproState extends State<Threaddespro> {
  var comments = "";
  @override
