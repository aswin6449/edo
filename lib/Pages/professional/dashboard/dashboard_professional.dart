...
import 'package:edo/Pages/professional/dashboard/chat/channels.dart';
import 'package:edo/Pages/professional/dashboard/thread/threads.dart';
...
class Pro_Dashboard extends StatefulWidget {
  const Pro_Dashboard({Key? key}) : super(key: key);
  @override
  State<Pro_Dashboard> createState() => _Pro_DashboardState();
}

class _Pro_DashboardState extends State<Pro_Dashboard> {
