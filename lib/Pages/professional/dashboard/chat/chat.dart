...
class ChatUip extends StatefulWidget {
  const ChatUip({Key? key}) : super(key: key);

  @override
  State<ChatUip> createState() => _ChatUipState();
}

class _ChatUipState extends State<ChatUip> {
  var message = "";
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text("Flutter - Mobile",style: TextStyle( fontSize: 16 ,fontWeight: FontWeight.w600,color: Colors.white),),
                        SizedBox(height: 6,),
