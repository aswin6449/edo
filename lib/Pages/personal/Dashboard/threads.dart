...
import 'package:edo/Pages/professional/dashboard/thread/thread_description.dart';
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            return Center(
              child: Lottie.asset('assets/animations/splash.json',height: 300),
            );
          } else {
            return ListView(
